...
CKEDITOR.plugins.add( 'simplebox', {
	...
	init: function( editor ) {
		...
		editor.widgets.add( 'simplebox', {
			...
			// * https://docs.ckeditor.com/#!/guide/plugin_sdk_integration_with_acf
			allowedContent:
			...
			//
			// Note: The "element" argument is an instance of https://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.element
